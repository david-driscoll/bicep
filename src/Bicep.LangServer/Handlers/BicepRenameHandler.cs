...
namespace Bicep.LanguageServer.Handlers
{
    public class BicepRenameHandler : RenameHandlerBase
    {
        ...
        public BicepRenameHandler(ISymbolResolver symbolResolver)
        {
        ...
        protected override RenameRegistrationOptions CreateRegistrationOptions(RenameCapability capability, ClientCapabilities clientCapabilities) => new RenameRegistrationOptions
        {
